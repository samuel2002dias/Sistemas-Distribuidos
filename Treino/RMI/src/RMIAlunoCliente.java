...
public class RMIAlunoCliente {
    public static void main(String[] argv) {
        try {
            RMIAlunoInterface alunosRemoteObject = (RMIAlunoInterface) Naming.lookup("//localhost:2222/RMIImpl");
            ...
            while (true) {
                ...
                switch (choice) {
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println(alunosRemoteObject.output());
                        break;
                    case 3:
                    ...
                    case 4:
                        System.out
                                .println("Número de acessos ao servidor: " + alunosRemoteObject.getServerCount());
                        break;
